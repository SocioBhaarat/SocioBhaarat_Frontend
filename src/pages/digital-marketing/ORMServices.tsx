            ...
            <div className="grid lg:grid-cols-12 gap-12 items-start">
              ...
              >
                ...
                <h1 className="text-4xl sm:text-6xl lg:text-7xl font-semibold text-slate-800 leading-[1.05] tracking-tighter">
                  Online <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-primary to-orange-500 font-medium">Reputation Management</span> Services
                </h1>
              ...
              >
                <div className="relative group">
                  ...
                  <div className="relative z-10 bg-white p-3 rounded-[3rem] shadow-2xl border border-white/50 overflow-hidden">
                    <img
                      src="https://res.cloudinary.com/djady4qza/image/upload/q_auto/f_auto/v1775722510/photo-1766853297154-3dcb4d3b38f8_vcn3po.jpg"
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto max-w-6xl px-4">
            ...
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold text-slate-800">
                Our ORM <span className="bg-gradient-to-r from-blue-600 via-primary to-orange-500 bg-clip-text text-transparent">
                  Services
                </span>
              </h2>
            </div>
