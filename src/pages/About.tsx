  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        {/* ABOUT SOCIO BHAARAT */}
        <section className="relative py-10 md:py-12 overflow-hidden bg-[#fafafa]">
        ...
        {/* SECTION 2: OUR STORY */}
        <section className="py-10 md:py-12 px-4 bg-white relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-7xl relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <div className="space-y-6 text-slate-800 text-md md:text-lg leading-relaxed border-l-4 border-primary/20 pl-8 font-medium">
                  <p>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    >
                      ...
                      <span className="text-slate-700 font-semibold tracking-wider text-sm md:text-base">{item.text}</span>
                    </motion.div>
                  ))}
                </div>
              </div>
